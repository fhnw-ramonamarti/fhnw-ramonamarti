\begin{table}[ht!]
    ...
    \begin{threeparttable}
        \begin{tabular}{ l || l | l | l }
            ...
            \cline{2-3}                     & Highlight-Wert wechseln \ccgray & Highlight-Wert wechseln \ccgray &  \\
            \hline
            ...
            \cline{2-3}       & Schreiben, Liste filtern\tnote{2} \ccgray  & \tbbr{Highlight-Wert ändern auf \\ Suchergenbis\tnote{3}} \ccgray & \\
            \hline
            ...
            \cline{2-3}     & Symbol löschen \& Liste filtern\tnote{2} \ccgray            & Highlight zu obestem Wert \ccgray & \\
            \hline
            \trr{Esc}   & -         & -                        & \trr{-} \\
            \cline{2-3} & - \ccgray & Liste schliessen \ccgray & \\
            \hline \hline
            \trrr{Enter} & \tbbr{Formular senden / \\ ohne Form nichts}                       & -                                                 & \trr{-} \\
            \cline{2-3}  & \tbbr{Gehighlighteter Wert wählen \& \\ Liste schliessen } \ccgray & \tbbr{Wert wählen \& \\ Liste schliessen} \ccgray &  \\
            \hline
