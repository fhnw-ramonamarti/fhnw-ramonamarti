\begin{table}[ht!]
    ...
    \begin{threeparttable}
        \begin{tabular}{ l || l | l | l }
            ...
            \cline{2-4}    & \tbbr{\textit{Aussen}: Liste schliessen \\ \textit{Innen}: Werte bewegen \\ ohne Änderung} \ccgray & \tbbr{\textit{Aussen}: - \\ \textit{Innen}: Werte bewegen \\ ohne Änderung} \ccgray & \tbbr{\textit{Aussen}: Browser-Default\tnote{1} \\ \textit{Innen}: Werte bewegen \\ ohne Änderung} \ccgray \\
            \hline
