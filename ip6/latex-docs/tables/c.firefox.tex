\begin{table}[ht!]
    ...
    \begin{threeparttable}
        \begin{tabular}{ l || l | l | l }
            ...
            \cline{2-3}                        & \tbbr{Cursor bewegen\tnote{1} / \\ Fokussierter Wert wählen} \ccgray & - \ccgray        &  \\
            \hline
            ...
            \hline
            \trr{Backspace} & \tbbr{Symbol löschen \& Liste gefiltert \\ öffnen\tnote{2} (wenn Feld nicht leer)} & -         & \trr{-} \\
            ...
            \cline{2-3}    & \tbbr{\textit{Aussen}: Liste schliessen \\ \textit{Innen}: Werte bewegen \\ \& Fokus ändert am Ende} \ccgray & \tbbr{\textit{Aussen}: Liste schliessen \\ \textit{Innen}: Werte bewegen \\ ohne Fokus ändern} \ccgray & \\
            \hline
