...
Die neue \codestyle{SelectComponent} baut auf der Länderauswahl auf, ist jedoch generalisiert. 
...
An diesem Punkt bietet Kolibri mit der \codestyle{SelectComponent} eine konsistente und anpassbare Auswahlkomponente – ohne externe Abhängigkeiten – an. 
...
Die aus den Feedbacks der Programmierer entstandene \codestyle{SelectComponent} sollte sich weiteren Tests mit Entwicklern stellen. 
...
Ein Interaktions-Projektor kann das Auswahlkomponentenbezogene Undo und Redo enthalten. 
