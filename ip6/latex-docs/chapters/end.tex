...
\footnotetext{Projektoren, die nur die View generieren (ohne Tastatur-Interaktion)}
...
\footnotetext{Wechsel der Cursor Position in die Kategorie oder ein Klick auf die Kategorie}
...
\footnotetext{Projektoren, die nur die Tastatur-Interaktion definieren}
...
Die \codestyle{SelectComponent} garantiert bis 5'000 Werte eine annehmbare\footnotemark \ Ladezeit.
\footnotetext{Ladezeit < 500ms bis die Webseite fertig geladen ist}
