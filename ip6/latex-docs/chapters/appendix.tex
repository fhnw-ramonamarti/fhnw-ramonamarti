...
\lstinputlisting[language = js, caption = userTesting.js, label = code:userTestingJs]{../userTest/userTesting.js}
\lstinputlisting[language = html5, caption = userTesting.html, label = code:userTestingHtml]{../userTest/userTesting.html}
\lstinputlisting[language = js, caption = starter.js, label = code:starterJs]{../userTest/starter.js}
\begin{lstlisting}[language = js, caption = dataServiceJs, label = code:dataService.js]
export {
    getAllContinents,
    getCountries,
    getCountriesChDeAt,
