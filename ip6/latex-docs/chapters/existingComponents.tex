...
Die nachfolgenden Abschnitte \ref{sec:edgeBrowser} bis \ref{sec:mobileBrowser} beschreiben die möglichen Interaktionen.
Die Tabellen stellen das Datalist, Single- als auch Multiselect einander gegenüber.
Im Anschluss an die Gegenüberstellungen der diversen Browser weist das Kapitel \ref{sec:summeryExisting} detaillierter auf die Inkonsistenzen hin. 
