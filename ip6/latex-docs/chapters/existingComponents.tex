...
Zudem zeigen tabellarische Gegenüberstellungen die Unterschiede und Inkonsitenzen dieser in verschiedenen Browsern und Betriebssystemen auf.
...
\footnotetext{in diesem Zusammenheng: $text$, $search$, $url$, $tel$, $email$, $password$}
...
\subsubsection{CSS für Input-Felder}
