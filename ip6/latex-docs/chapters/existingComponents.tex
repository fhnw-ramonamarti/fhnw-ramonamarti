...
Das \texttt{option}-Element wird bei beiden Auswahlkomponenten - \texttt{datalist} und \texttt{select} - verwendet. 
...
Das bedeutet, es können keine weiteren Elemente verschachtelt werden.
Als Eltern-Elemente sind \texttt{select}, \texttt{optgroup} und \texttt{datalist} erlaubt.
Alle gängigen Browser unterstützen dieses Element.
