...
Firefox zeigt das Feld in grau (Abbildung \ref{img:closedSelectFirefox}), während Chrome und Edge einen weissen Hintergrund (Abbildung \ref{img:closedSelectChrome}) verwenden. 
...
Der Fokus dieses Abschnitts liegt aber auf der Interaktion, da das UI bereits im Kapitel \ref{sec:uiDifferences} genauer beschrieben ist. 
...
Während die offene Datalist auf Firefox mit den seitlichen Pfeiltasten zwei unterschiedliche Reaktionen zeigt, reagiert sie im Chrome-Browser immer auf dieselbe Weise. 
