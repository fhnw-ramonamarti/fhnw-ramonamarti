...
Ein Pattern, welches im Verlauf der Arbeit eine wichtige Rolle eingenommen hat, ist das Null-Object Pattern\citemark.
...
Das Projector Pattern\citemark \ basiert auf dem verbreiteten Model-View-Controll Pattern.
...
Ein Decorator\citemark \ bietet zusätzliches Verhalten ohne das Originale Objekt zu verändern.
...
Weiter ist darauf achten, dass CSS-Klassen\citemark \ an Stelle von Inline-Styles\footnotemark \ ihre Verwendung finden.
