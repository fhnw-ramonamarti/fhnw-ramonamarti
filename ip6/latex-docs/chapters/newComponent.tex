...
\begin{itemize}
    ...
    \item \textbf{Regula}: 
          Verwendet die Navigation anfangs wie bei herkömmlichen Jahresauswahlmenüs. 
\end{itemize}
...
Die Möglichkeit, gezielt nach Jahrzehnten und Kontinenten zu filtern, beschleunigte den Auswahlprozess signifikant. 
