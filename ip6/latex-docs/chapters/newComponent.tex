...
Als Beispiel dient die \codestyle{SelectComponent} mit drei Spalten aus Abbildung \ref{img:manualTestComponentOsx}. 
...
In veraltete Browser ist die \codestyle{SelectComponent} mit leichten Einbussen nutzbar. 
...
Die ermöglicht eine unerwünschte Darstellung von überschneidenden Listencontainer. 
Das restliche UI zeigt kaum Abweichungen. 
Die Interaktionen funktionieren alle wie in den aktuellen Versionen der Browser. 
Im Controller sind jedoch gewisse Zustände nicht konsistent mitgeführt, da ohne das Popover das Toggle-Event nicht reagiert. 
