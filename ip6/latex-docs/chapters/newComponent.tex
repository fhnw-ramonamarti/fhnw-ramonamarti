...
Das vordefinierte \texttt{--kb-color-select} eignet sich am ehesten als Hintergrundfarbe.
...
Mit einem gut erkennbaren Kontrast zur Selektion bietet sich das dunkle Gelb aus \texttt{--kb-warning-dark} an.
