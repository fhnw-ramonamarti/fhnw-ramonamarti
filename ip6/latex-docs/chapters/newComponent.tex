...
Für ein konsistent gehaltenes UI sind diverse Event-Handler und UI-Update-Funktionen notwendig. 
Im \codestyle{columnOptionsProjector.js} existiert beispielsweise ein Event-Handler, der das Setzen und Entfernen der Selektions-Klasse steuert. 
...
Das hier versendete \codestyle{getHtmlElementByOption} sucht im Teilbaum des DOMs das HTML-Element zur mitgegenen Option. 
...
\subsubsection{Endanwendern} % todo
