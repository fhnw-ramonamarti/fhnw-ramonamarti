...
Die ersten zwei Testbibliotheken kümmern sich um die Korrektheit von den in den Dateien \texttt{optionsModel.js} und \texttt{optionsController.js} enthalten Funktionalitäten. 
