...
Einige zusärtliche CSS-Definitionen garanieren eine halbwegs ansehnliche Darstellung. 
Alle Browser, welche das nested CSS\footnote{
    Verschachtelter CSS-Code mit Verwendung der \&-Funktionalität
} nicht unterstützen, können die neue Komponente nicht sauber anzeigen. 
