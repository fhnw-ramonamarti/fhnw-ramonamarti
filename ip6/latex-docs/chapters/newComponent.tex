...
Dadurch ist eine optimale Lesbarkeit und Bedienbarkeit gewähltet. 
Diese Punkte sind durch die durchgeführte Tests bewiesen. 
...
Eine klare Interaktionen-Definition garantiert Maus- als auch für Tastaturbenutzern eine gute Zugänglichkeit. 
...
Die Wahl der Popover-API vereinfacht die Implementation enorm, indem weniger zusätzliche Funktionalität notwendig ist. 

Stetig durchgeführte, manuelle Tests ermöglichen eine Überwachung und einen Vergleich der Performance. 
Optimierungen im Code führen zu einer schenlleren Performance und einer angenehmen Benutzererfahrung. 
