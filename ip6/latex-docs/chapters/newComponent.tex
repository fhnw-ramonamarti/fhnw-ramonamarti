...
Es ist speziell, dass \codestyle{serviceCallbacks}-Array in umgekehrter Reihenfolge – im Gegensatz zum UI – einzugeben ist.
\\
\textbf{Navigation}: 
Die Tastaturnavigation ist nicht ideal. 
Die Verwendung der Tastatur zum Eingrenzen möglicher Kategorien/Werte – unscharfe Suche – wäre eine Möglichkeit. 
...
\\
\textbf{Leere Spalten}: 
Wenn man zwei Kolonnen hat, aber rechts keine Auswahl, dann kann man auch nichts auswählen. 
Ja, ist zu erwarten, aber nicht ideal für die Demo. 
...
Die Anpassung der Farbauswahl und Kontraste ist wichtig, dass eine hohe Lesbarkeit und Benutzerfreundlichkeit gewährleistet sind. 
\\
...
Dazu unterützt eine Umgestaltung des Return-Werts die Verständlichkeit der Elemente. 
\\
\textbf{Interaktion}: 
...
Die daraus resultierende Version der Komponente erhöht Entwicklerfreundlichkeit durch einen alternativen Konstruktor. 
