...
Das vordefinierte \codestyle{-{}-kb-color-select} eignet sich am ehesten als Hintergrundfarbe. 
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{figma-prototype-1.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{figma-prototype-2.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{figma-prototype-3.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=60mm]{design-colors.png}
...
\begin{itemize}
    ...
    \item Kolibri-Light/Yellow/300 bzw. \codestyle{-{}-kb-color-select} $\rightarrow$ selected
...
Das hier verwendete \codestyle{getHtmlElementByOption} sucht nur im mitgebenen Teilbaum des DOMs das HTML-Element zur mitgegebenen Option. 
...
Eine weitere Rolle spielt unter anderem die Master-Detail-View, welche bereits im Kapitel \textbf{\nameref{sec:masterDetailView}} erläutert ist. 
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{diagram-select-component-old.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{diagram-column-component-with-desc.png}
...
Bei einer Anwendung übernimmt die \codestyle{ColumnOptions\-Component} die Verwaltung gewisser Bausteine. 
Mehr zu dem Baustein folgt im Kapitel \textbf{\nameref{sec:decoratorPattern}}. 

\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{diagram-select-component-with-desc.png}
...
Der \codestyle{SelectComponent\-By\-TableValues} in Code \ref{code:componentDecorator} dekoriert die \codestyle{SelectComponent\-By\-Callbacks}. 
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=100mm]{performance-before-user-tests-zoom.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=100mm]{performance-after-user-tests-zoom.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=70mm]{newComponent/opened.3col.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=70mm]{newComponent/win.chrome.png}
...
Der \codestyle{Options\-Controller} und der \codestyle{SelectedOption\-Controller} finden sich in einer gemeinsamen Test-Datei wieder. 
Der \codestyle{project\-ColumnOptions\-View}-Test deckt die Kontrolle der Bindings und die Existenz der View-Elemente ab. 
...
\begin{figure}[!htb]
    ...
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{userTests/richtung9.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=95mm]{userTests/desc9.png}
...
Die originalen Feedbacks befinden sich im Anhang \textbf{\ref{chap:userTestProgrammers}}. 
 \\
\textbf{Dokumentation \& Return-Wert}: 
Das JSDoc der \codestyle{SelectComponent} benötigt eine detailliertere Beschreibung des Return-Arrays. 
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Regula}: 
              Findet die Filter nützlich, da das Scrollen im speziellen bei der Jahrgangsauswahl nervenaufreibend sein kann. 
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Regula}: 
          Empfindet das Design klar gestaltet. 
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Regula}: 
          Verwendet die Navigation zu Beginn wie bei herkömmlichen Jahresauswahlmenüs.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Regula}: 
          {\color{editorGreen} 8/10} – Brauchte zwar einen Bedienungshinweis, findet es jedoch super. 
          Das Scrollen bei ihrem Jahrgang ist in anderen Dropdown Menüs nervenaufreibend. 
\end{itemize}
...
Die neue Dropdown-Komponente ermöglicht eine intuitive Bedienung. 
Diese findet sowohl bei Digital Natives als auch bei weniger geübten Nutzern Akzeptanz. 
Die mehrspaltigen Filteroptionen sind als besonders hilfreich hervorgehoben. 
Sie erleichtern die Navigation in umfangreichen Listen erheblich. 
\\
...
Die visuelle Gestaltung der neuen Dropdown-Komponente bewerten die Testpersonen als klar und ansprechend. 
Besonders die logische Struktur und die unaufdringliche Präsentation tragen zu einer positiven Benutzererfahrung bei. 
\\
\textbf{Effizienzsteigerung}: 
Die Möglichkeit, gezielt nach Jahrzehnten und Kontinenten zu filtern, beschleunigt den Auswahlprozess signifikant.
Dies erkennen die Testpersonen als wesentlicher Vorteil gegenüber herkömmlichen, nicht gefilterten Dropdown-Menüs. 
Tastatur-Shortcuts nutzen nur zwei der Testpersonen. 
Eine breitere Nutzung dieser Funktion steigert die Effizienz der Bedienung weiter. 
...
Die meisten Nutzer empfinden die Komponente als benutzerfreundlich. 
Bei älteren Nutzern ist ein Bedarf nach einer kurzen Einführung in die Bedienung vorhanden. 
\\
\textbf{Weiterentwicklung}: 
Die Tests zeigen, dass es sinnvoll sein könnte, eine Funktion zu integrieren, die eine flexiblere Navigation innerhalb der Dropdown-Menüs ermöglicht. 
Beispielsweise kann durch das Fortsetzen des Scrollens in Kategorien oder eine vereinfachte Variante für spezifische Nutzergruppen Abhilfe schaffen. 
