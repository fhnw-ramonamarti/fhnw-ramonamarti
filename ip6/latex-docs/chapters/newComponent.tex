...
Die diversen oben beschrieben Design-Schritte resultieren in den Abbildungen \ref{img:closedNewComponent} bis \ref{img:openedThreeColCatNewComponent}. 
...
\begin{figure}[!htb]
    ...
    \begin{minipage}[b]{0.35\textwidth}
        ...
        \caption{\centering Offene \codestyle{SelectComponent} – 3 Zuständen}
...
Im geschlossen Zustand (Abbildungen \ref{img:closedNewComponent}) zeigt der Pfeil auf der rechten Seite nach unten. 
...
Dies ist in Abbildungen \ref{img:closedImgNewComponent} im oberen Bereich ersichtlich. 
Ist das Feld required, erhält der Rahmen einen rosanen Rahmen. 
Dabei ist der Fokus aber nicht überdeckt. 
Die disablete \codestyle{SelectComponent} zeigt sich wie die anderen Eingabefelder ebenfalls ausgegraut. 

Die offene Komponente stellt den Options-Container in jedem Fall unterhalb dar. 
Die Abbildung \ref{img:openedHighlightedCursoredSelectedNewComponent} enthält die drei aktuell möglichen Zustände der einzelnen Optionen – nebst normal. 
