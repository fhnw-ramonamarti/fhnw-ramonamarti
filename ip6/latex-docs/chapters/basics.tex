...
Mehreren Schritte wandeln die einzelnen HTML-Elementen in sogenannte Nodes um. 
...
Dieses Wissen ist wichtig für das spätere Kapitel \nameref{sec:performance}. 
Der Grund ist, dass der Browser maximal 60 Mal pro Sekunde rendern kann.
Jeder Änderung am Browser-DOM\footnotemark \ startet der komplette Rendering Prozess von vorne.
...
\begin{itemize}
    ...
    \item Änderungen von Inhalt (auch von Formularfeldern)
