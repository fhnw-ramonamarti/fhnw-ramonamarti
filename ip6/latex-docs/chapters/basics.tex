...
\section{Zustände in einer Auswahlkomponent}
...
Ist ein Wert in der Master-Ansicht ausgewählt und wird in der Detail-View angezeigt, ist dieser $selekitert$.
...
Bestätigt der Nutzer das $gehighlightete$ Value, wechselt der Status auf selektiert.
