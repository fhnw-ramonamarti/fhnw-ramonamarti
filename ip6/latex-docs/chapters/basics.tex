...
In diesem Fall betreffen Interaktionen über die Tastatur nicht das Element. % todo besser schreiben, unklar
...
Durch Hovern kann der Highlight-Wert geändert werden. % todo hover in glossar
