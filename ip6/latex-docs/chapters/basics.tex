...
\begin{figure}[!htb] % todo img
    ...
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        % \includegraphics[width=\textwidth]{component-close.png}
        \caption{\centering \color{red} Geschlossene Komponente}
        \label{img:componentClose}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        % \includegraphics[width=\textwidth]{component-open.png}
