...
Die Vorarbeit\citemarktext{
    [\cite{ip5}]
} beinhaltet einen Recherche- als auch einen Design- und Implementationsbestandteil. 
Die Recherche legt den Fokus auf das Prototyping und diverse Code- und Implementations-Bausteine. 
Die Anwendung der Informationen aus den Recherchen finden sich im Weg zur Länderauswahl als auch der Komponente wieder. 
...
Die zuvor genannten Schritte sind in diesem Bericht vor der eigentlichen Datenerhebung nicht weiter von Bedeutung.
...
Zu den Browsern, die Blink als Rendering-Engine nutzen, gehören unter anderem Google Chrome, Brave, Microsoft Edge, Opera und Vivaldi.\citemarktext{
...
AFirefox und weitere auf Mozilla\citemarktext{
    [\cite{mozillaBrowser}]
} basierende Browser, die Webseiten mit Gecko rendern, sind die bekanntesten Vertreter der verbleibenden Browser.
