...
Das Hovern kann der Highlight-Wert ändern. 
...
\section{Browser \& HTML Renderer} % todo shorten, only relevant, check references performance
...
Die Rendering-Engine interpretiert die gegebenen Inhalte, die Renderer anhand des Inhaltstyps wählt. 
...
\subsection{Rendering-Prozess}  % todo shorten
...
Der Entwickler schreibt Zeichen in eine HTML-Datei.
...
Dieses Ergebnis nennt sich CSS Object Model - kurz CSSOM - aus Abbildung \ref{img:RenderingProcess} und enthält die Design-Informationen der Elemente.
...
WebKit\footnotemark \ – als der Vorgänger des geläufigsten Renderer – findet sich im OSX Webbrowser Safari wieder.
