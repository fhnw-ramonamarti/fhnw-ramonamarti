...
Das \textbf{Implementationsresultat} visualiert und beschreibt die neue Komponente in diversen Beispielen.
...
Der \textbf{Dropdown-Container} (\textbf{\ref{sec:dropdownContainer}}) lässt sich auf verhschiedene Weise umsetzen. 
