...
Dieses Projekt bezieht sich auf die Entwicklung ein Komponente für Nutzer ohne Seheinschränkungen.
Daher spielt die Accessability nur eine begrenzte Rolle.
Screen-Reader müssen nicht beachtet werden, da dies zu umfangreich ist.
Für die generalisierte Komponente reicht es, wenn die Auswahl eines Wertes möchlich ist.
Die Auswahl mehrer Werte im selben Eingabe-Elemente ist nicht gefordert.
Weiter ist die Eingabe eines eigenen Wertes in die neue Komponente ebenfalls ausserhalb der Anforderungen.
...
Im Rahmen befindet sich das Erweitern des SimpleInput um die Möglichkeiten eines Auswahl-Inputs.
